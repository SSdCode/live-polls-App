...
import com.sdcode.livepolls.PollInfo;
...
public class MyPollsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_my_polls, container, false);
        ...
        recyclerView = v.findViewById(R.id.myPollsRV);
        databaseHelper = new DatabaseHelper(getContext());

        myPollsRVAdapter = new MyPollsRVAdapter(databaseHelper.getMyPollsData(email));
        ...
        myPollsRVAdapter.setOnItemClickListener(new MyPollsRVAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent i = new Intent(getContext(), PollInfo.class);
                i.putExtra("qid", qid);
                i.putExtra("op1", op1);
                i.putExtra("op2", op2);
                i.putExtra("op3", op3);
